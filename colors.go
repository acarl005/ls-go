...
var (
	...
	FileColor     = map[string][2]string{
		...
		"jsx":       [2]string{Bold + Fg(87), Fg(73)},
		"coffee":    [2]string{Bold + Fg(136), Fg(94)},
		"cson":      [2]string{Bold + Fg(136), Fg(94)},
		"java":      [2]string{Bold + Fg(136), Fg(94)},
		...
		"scala":     [2]string{Bold + Fg(124), Fg(52)},
		"ts":        [2]string{Bold + Fg(33), Fg(20)},
		"c":         [2]string{Bold + Fg(33), Fg(20)},
		"cpp":       [2]string{Bold + Fg(33), Fg(20)},
		"h":         [2]string{Bold + Fg(33), Fg(20)},
		"cs":        [2]string{Bold + Fg(33), Fg(20)},
		"m":         [2]string{Bold + Fg(33), Fg(20)},
		"php":       [2]string{Bold + Fg(30), Fg(22)},
		"sql":       [2]string{Bold + Fg(193), Fg(148)},
		"tsql":      [2]string{Bold + Fg(193), Fg(148)},
		"psql":      [2]string{Bold + Fg(193), Fg(148)},
		"plsql":     [2]string{Bold + Fg(193), Fg(148)},
		"plpgsql":   [2]string{Bold + Fg(193), Fg(148)},
		"swift":     [2]string{Bold + Fg(223), Fg(215)},
